...
const MyPatientsReports = () => {
  ...
  const getReportDescription = () => {
    switch (reportType) {
      case "30months":
        return "Comprehensive report of your patients and appointments from the last 30 days";
      case "12months":
    ...
    <div className="m-2 w-full sm:w-[80vw] flex flex-col items-center sm:items-start justify-center pb-2 gap-6 sm:p-4 bg-gray-50 rounded">
      <div className="w-full">
        ...
        <p className="text-gray-600 px-1">
          Generate and download comprehensive reports of your patients and
          analytics
        </p>
      </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <ul className="text-sm text-blue-700 mt-2 space-y-1">
                  <li>
                    • Your patient personal information and contact details
                  </li>
...
export default MyPatientsReports;
